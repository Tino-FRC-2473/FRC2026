...
public class Drivetrain extends FSMSystem<Drivetrain.DrivetrainState> {
	 ...
	 * @return Command
	 */
	public Command followcommand(String pathName) {
		System.out.println(AutoBuilder.isConfigured());
		try {
			// Load the path from the deploy directory
			PathPlannerPath path = PathPlannerPath.fromChoreoTrajectory(pathName);

			// AutoBuilder already knows your pose, speeds, and drive method
			// because of the configuration you did in robotInit/constructor.
