...
package frc.robot.imported.util;
...
public class FieldConstants {
    ...
    public static final int aprilTagCount = TAG_LAYOUT.getTags().size();
    public static final double aprilTagWidth = Units.inchesToMeters(6.5);

    // Field dimensions
    public static final double fieldLength = TAG_LAYOUT.getFieldLength();
    public static final double fieldWidth = TAG_LAYOUT.getFieldWidth();
    ...
    public static class LinesVertical {
        ...
        public static final double starting = TAG_LAYOUT.getTagPose(26).get().getX();
        public static final double allianceZone = starting;
        public static final double hubCenter = TAG_LAYOUT.getTagPose(26).get().getX()
                + Hub.width / 2.0;
        ...
        public static final double oppHubCenter = TAG_LAYOUT.getTagPose(4).get().getX()
                + Hub.width / 2.0;
        public static final double oppAllianceZone = TAG_LAYOUT.getTagPose(10).get()
                .getX();
    }
    ...
    public static class Hub {
        ...
        public static final Translation3d topCenterPoint = new Translation3d(
                TAG_LAYOUT.getTagPose(26).get().getX() + width / 2.0,
                fieldWidth / 2.0,
                height);
        ...
        // Hub faces
        public static final Pose2d nearFace = TAG_LAYOUT.getTagPose(26).get().toPose2d();
        public static final Pose2d farFace = TAG_LAYOUT.getTagPose(20).get().toPose2d();
        public static final Pose2d rightFace = TAG_LAYOUT.getTagPose(18).get().toPose2d();
        public static final Pose2d leftFace = TAG_LAYOUT.getTagPose(21).get().toPose2d();
    }
    ...
    public static class Tower {
        ...
        public static final Translation2d centerPoint = new Translation2d(
                frontFaceX, TAG_LAYOUT.getTagPose(31).get().getY());
        public static final Translation2d leftUpright = new Translation2d(
                frontFaceX,
                (TAG_LAYOUT.getTagPose(31).get().getY())
                        + innerOpeningWidth / 2
    ...
    public static class Outpost {
        ...
        public static final Translation2d centerPoint = new Translation2d(0,
                TAG_LAYOUT.getTagPose(29).get().getY());
    }
    ...
    public static class FuelPool {
        ...
        // Relevant reference points on alliance side
        public static final Translation2d nearLeftCorner = new Translation2d(fieldLength / 2.0 - depth / 2.0,
                fieldWidth / 2.0 + width / 2.0);
        public static final Translation2d nearRightCorner = new Translation2d(fieldLength / 2.0 - depth / 2.0,
                fieldWidth / 2.0 - width / 2.0);
        public static final Translation2d leftCenter = new Translation2d(fieldLength / 2.0,
                fieldWidth / 2.0 + width / 2.0);
        public static final Translation2d rightCenter = new Translation2d(fieldLength / 2.0,
                fieldWidth / 2.0 - width / 2.0);
    }
}
